 ...
 * 管理画面のサイドバーの表示順を変更する
 *
 * 参考：https://web-parts-box.com/wordpress/menu-order-01/
 */
function custom_menu_order($menu_ord)
{
	...
	return array(
		...
		'separator1', //最初の区切り線
		'edit.php', //デフォルト投稿タイプ
		'edit.php?post_type=works', //カスタム投稿タイプ
		'edit.php?post_type=blog', //カスタム投稿タイプ
 ...
 *
 * 参考：https://junpei-sugiyama.com/contact-form-7-thanks-page/
 */
add_action('wp_footer', 'add_origin_thanks_page');
function add_origin_thanks_page()
{
	$thanks = home_url('/contact_thanks/');
	echo <<< EOC
    <script>
      var thanksPage = {
        211: '{$thanks}',
